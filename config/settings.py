...
CLEAN_INTERVAL = int(os.getenv("CLEAN_INTERVAL", 7 * 24 * 60 * 60))  # 清理过期用户的时间间隔（秒），默认为 7 天
ENABLE_EXPIRED_USER_CLEAN = bool(os.getenv("ENABLE_EXPIRED_USER_CLEAN", False)) # 是否开启定时任务，默认关闭